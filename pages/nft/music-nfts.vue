<template>
  <Head>
    <Title>Music NFTs | {{ $config.public.projectMetadataTitle }}</Title>
  ...
  <div class="card border scroll-500">
    <div class="card-body">
      ...
      <NftListDropdown buttonText="Music NFTs" />
...
export default {
  ...
  methods: {
    async fetchNfts(clear="false") {
      ...
      // Fetch NFTs
      try {
        let url = `/api/endpoint/read/nft-list-music?limit=${this.limit}`;
